...
{ username: 'Guest',
  ...
  password: "password",
  avatar: "http://jeremytaylor.eu/wp-content/uploads/2012/01/sc01bc.jpg"
},{ username: 'Aislinn',
...
comments = Comment.create([{author_id: 3, activity_id: 12, content: "killin it!"},
{author_id: 7, activity_id: 12, content: "heeeeeeyyyyoooo"}])

likes = Like.create([{liker_id: 7, activity_id: 12},
{liker_id: 3, activity_id: 9},
{liker_id: 6, activity_id: 11},
{liker_id: 6, activity_id: 12},
{liker_id: 4, activity_id: 12},
{liker_id: 3, activity_id: 12}])
